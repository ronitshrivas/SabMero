        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentMethod = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, defaultValue: "COD"),
                    PaymentStatus = table.Column<string>(type: "character varying(15)", maxLength: 15, nullable: false, defaultValue: "Pending"),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "Pending"),
                    DeliveryAddress = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceAddress = table.Column<string>(type: "character varying(400)", maxLength: 400, nullable: false),
                    DamageImagePath = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false, defaultValue: "Pending"),
                    ...
                    ServiceCharge = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedSize = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: true),
                    SelectedColor = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceBookingId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Reviews_ServiceBookings_ServiceBookingId",
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedAt", "ImagePath", "IsActive", "Name" },
                values: new object[,]
                {
                    { 1, new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Utc), null, true, "Electronics" },
                    { 2, new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Utc), null, true, "Clothing" },
                    { 3, new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Utc), null, true, "Footwear" },
                    { 4, new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Utc), null, true, "Grocery" }
                });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Address", "CreatedAt", "Email", "FullName", "IsActive", "IsKycVerified", "KycDocumentPath", "PasswordHash", "Phone", "Role" },
                values: new object[] { 1, "Kathmandu, Nepal", new DateTime(2026, 6, 4, 0, 0, 0, 0, DateTimeKind.Utc), "admin@sabmero.com", "sabmero Admin", true, true, null, "$2a$11$rQarYeyOZOiWAq.yLO/NfO0v1Z4SMD4/PhLAaTkEr07q92mmrqJfm", "9800000000", "Admin" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ServiceBookingId",
                table: "Reviews",
